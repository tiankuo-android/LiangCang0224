package com.atguigu.tiankuo.liangcang0224.fragment.shopfragment.fragment.specialfragment;
...
public class SubjectActivity extends AppCompatActivity {
    ...
    WebView webView;
    @InjectView(R.id.activity_subject)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = intent.getStringExtra("accessid");
