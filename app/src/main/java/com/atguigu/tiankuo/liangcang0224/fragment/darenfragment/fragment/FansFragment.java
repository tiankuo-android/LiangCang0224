...
public class FansFragment extends BaseFragment {
    ...
    public View initView() {
        View view = View.inflate(mContext, R.layout.activity_fans_fragment, null);
    ...
    public void initData() {
        super.initData();
        url = "http://mobile.iliangcang.com/user/masterFollowed?app_key=Android&count=10&owner_id="
                + userid +
