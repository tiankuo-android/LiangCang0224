...
import com.atguigu.tiankuo.liangcang0224.utils.pay.SignUtils;
...
public class ShoppingCartActivity extends AppCompatActivity {
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        Toast.makeText(ShoppingCartActivity.this, "支付成功",
                                Toast.LENGTH_SHORT).show();
                    } else {
                        // 判断resultStatus 为非“9000”则代表可能支付失败
                        // “8000”代表支付结果因为支付渠道原因或者系统原因还在等待支付结果确认，最终交易是否成功以服务端异步通知为准（小概率状态）
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(ShoppingCartActivity.this, "支付结果确认中",
                                    Toast.LENGTH_SHORT).show();
                ...
                case SDK_CHECK_FLAG: {
                    Toast.makeText(ShoppingCartActivity.this, "检查结果为：" + msg.obj,
                            Toast.LENGTH_SHORT).show();
                    break;
                }
                default:
    ...
    private void showPay(double totalPrice) {
        // 订单
