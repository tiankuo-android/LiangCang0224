...
public class AgoraAdapter extends RecyclerView.Adapter<AgoraAdapter.MyViewHolder> {
    private final List<StoreBean.DataBean.ItemsBean> datas;
    private final AgoraActivity context;

    public AgoraAdapter(AgoraActivity storeActivity, List<StoreBean.DataBean.ItemsBean> datas) {
