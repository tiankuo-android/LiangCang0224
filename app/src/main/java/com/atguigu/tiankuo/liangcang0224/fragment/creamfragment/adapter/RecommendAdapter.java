...
import com.atguigu.tiankuo.liangcang0224.utils.Utils;
...
public class RecommendAdapter extends BaseAdapter {
    ...
    public RecommendAdapter(Context mContext, List<CreamBean.ListBean> datas) {
    ...
    public int getItemViewType(int position) {
        int itemViewType = -1;
        CreamBean.ListBean listBean = datas.get(position);
    ...
    private View initView(View convertView, int itemViewType, CreamBean.ListBean mediaItem) {
        switch (itemViewType) {
            case TYPE_VIDEO://视频
...
//                Glide.with(mContext).load(mediaItem.getVideo().getThumbnail().get(0)).into(jcvVideoplayer.thumbImageView);
                Glide.with(mContext)
                        ...
                        .placeholder(R.drawable.bg_activities_item_end_transparent)
                        .error(R.drawable.bg_activities_item_end_transparent)
    ...
    private class BaseViewHolder {
        ...
        public void setData(CreamBean.ListBean mediaItem) {
            ...
            List<CreamBean.ListBean.TagsBean> tagsEntities = mediaItem.getTags();
